...
<html lang="en">
    <head>
        ...
        <link href="front_assets/css/styles.css" rel="stylesheet" />
    </head>
    <body id="page-top">
        <!-- Navigation-->
                ...
                <?php foreach($projects as $pro):?>
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal1">
                            ...
                            <img class="img-fluid" src="dashboard/upload/<?php echo $pro['img']; ?>" alt="" />
                        </div>
                    </div>
                <?php endforeach; ?>    
        ...
        <!-- Contact form JS-->
        <script src="front_assets/assets/mail/jqBootstrapValidation.js"></script>
        <script src="front_assets/assets/mail/contact_me.js"></script>
        <!-- Core theme JS-->
